...
class BEAgent(BaseDomainAgent):
    domain = "be"
    
    def generate_scene(self, session_context, difficulty, scene_number):
        return {
            "scene_type": "backend_implementation",
            "scene_number": scene_number,
            "title": "BE Scene (coming soon)",
            "description": "BE simulation scene — agent implementation in progress.",
    ...
    def evaluate_response(self, scene, student_response, session_context):
        return {
            ...
            "behavioural_flags": [], "justification": "BE evaluation coming soon.",
