...
class SQAAgent(BaseDomainAgent):
    domain = "sqa"
    ...
    def generate_scene(self, session_context, difficulty, scene_number):
        return {
            ...
            "title": "SQA Scene (coming soon)",
            "description": "SQA simulation scene — agent implementation in progress.",
    ...
    def evaluate_response(self, scene, student_response, session_context):
        return {
            ...
            "behavioural_flags": [], "justification": "SQA evaluation coming soon.",
